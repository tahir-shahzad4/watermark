...
dirfrom = '/home/tahir/Pictures/Nikond5200/'
dirto = '/home/tahir/Pictures/Nikond5200-edited/'
# Check whether the specified path exists or not
isExist = os.path.exists(dirto)
...
for filename in sorted(os.listdir(dirfrom)):
    if filename.endswith(".JPG"):
        print(dirfrom + filename)
        #do smth
        img = cv2.imread(dirfrom + filename)
